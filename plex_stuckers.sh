#!/usr/bin/env bash
# https://github.com/maximuskowalski/maxmisc/blob/master/plex_stuckers.sh

# This script resets the `added_at` dates of Plex items to their airdate or premiere date.
